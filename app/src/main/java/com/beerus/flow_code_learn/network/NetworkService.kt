package com.beerus.flow_code_learn.network
...
interface SunflowerService {
    ...
    @GET("googletest/kotlin-coroutines/master/advanced-coroutines-codelab/sunflower/src/main/assets/custom_plant_sort_order.json")
